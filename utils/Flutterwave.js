...
class Flutterwave {
	constructor(secretKey, publicKey, encryptKey) {
		this.secretKey = "FLWSECK_TEST-5719b3a6a881bbafb3d8833ac563428c-X";
		this.publicKey = "FLWPUBK_TEST-fe3d83f5f2d8826e0c88a7735c790551-X";
		this.encryptKey = "eFLWSECK_TESTa6097fc45eeb";
	}
	...
	async payWithBankTransfer(data) {
		try {
			let { amount, email, currency, tx_ref } = data;
	...
	async verifyAccountNumber(data) {
		try {
			let { accountNumber, bankCode } = data;
			let toBeSentData = {
