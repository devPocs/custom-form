...
//send mail for false verification
exports.unverified = catchAsync(async (req, res, next) => {
  ...
  const mailOptions = {
    ...
    to: email,
    subject: "Surveyor's Conference, 2023",
    text: `<h2>Hello, ${name},</h2> <p>False Receipt Uploaded. Verification Failed!!!.</p> `,

    html: `<h2>Hello, ${name},</h2> <p>False Receipt Uploaded. Verification Failed!!!.</p> `,
  };
